...
배경은 실시간 날씨와 시각에 따라 20가지 이상의 조합으로 변합니다. 맑은 밤에는 짙은 남보라빛 하늘에 별이 반짝이고, 운량에 따라 별의 밀도가 달라집니다. 구름 낀 날에는 블러 처리된 구름 덩어리가 천천히 흘러갑니다. 일출과 일몰 전후의 황혼 시간대에는 남색에서 보라, 자홍, 주황으로 이어지는 노을 그라데이션이 배경을 채웁니다.
